...
import { WhatsOnChain, NodejsHttpClient, ARC, MerklePath } from '@bsv/sdk'
...
import { MeterLookupService } from './meter-services/MeterLookupService.js'
...
import { MeterStorage } from './meter-services/MeterStorage.js'
...
import { MeterTopicManager } from './meter-services/MeterTopicManager.js'
...
const initialization = async () => {
  ...
  try {
    ...
    try {
      ...
      const meterStorage = new MeterStorage(db)
      ...
      engine = new Engine(
        ...
        },
        {
          ...
          ls_meter: new MeterLookupService(meterStorage)
        },
