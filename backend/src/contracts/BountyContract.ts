import {
  ...
  export class BountyContract extends SmartContract {
    ...
    // Creator identity key (public key for authentication)
    @prop()
    readonly creatorIdentityKey: ByteString
  
    // Creator signature (to verify authenticity)
    @prop()
    readonly creatorSignature: ByteString
